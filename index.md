...
Разрабатываю системное П.О, игры и автоматизирую процессы.</br></br>
...
Выдуманный никнейм **Lukov** и сопутствующие (кроме имени), не несут никакой информации из реальной жизни. Это всего лишь виртуальное имя.</br></br>
...
Цель проекта: Движок, позволяющий симулировать и изучать искусственные миры.</br></br>

Этот проект должен дать начало направлению разработки своих полноценных симуляций миров, и помочь исследованию и улучшению построения искусственных миров в компьютерных вычислительных системах.</br></br>

Это не тоже самое, что **"VR/AR"** _(и подобное)._ Это именно **полноценное**, технически возможное, симулирование миров.</br>
Это несовсем "игра", где всё строится вокруг игрока и оптимизациях. Это **симуляция среды и её исследование.**</br></br>
