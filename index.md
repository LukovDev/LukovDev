...
Прямой наследник этого проекта - [CGDF](https://github.com/LukovDev/CGDF), который строится по принципу и апи этого движка.</br></br>

Документации не существует. Только документированный исходный код.</br>
...
Документация [**существует**](https://github.com/LukovDev/CGDF/tree/master/docs) (с момента 29.03.2026). Разделяется на 2 основные части:</br>
- Общее представление и объяснение.</br>
- Документация по API из исходного кода (используя генератор который автоматически создает документацию по API из исходного кода).</br>
