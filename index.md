...
Это прямой потомок проекта **[PyGDF](https://github.com/LukovDev/PyGDF)**, но с переходом на языки C и частично C++</br>

Проект был создан как единая кроссплатформенная (для ПК) среда разработки игр и софта. Благодаря опыту разработки фреймворка **PyGDF**, в этом проекте учитываются разные нюансы и проблемы, которые нельзя было решить в PyGDF.</br>
